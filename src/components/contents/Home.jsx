    ...
    return (
        <Container fluid id="home" className='hero-section'>
            <svg className="curve-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 900" preserveAspectRatio="xMidYMid meet">
                <path d="M420,-700 A700,800 900 0 0 1500,300" stroke="var(--section-content)" strokeWidth="3" fill="none" />
                <circle cx="650" cy="390" r="100" stroke="var(--section-content)" strokeWidth="3" fill="none" />
            </svg>
